# Gen-AI-Powered-Customer-Support-Quality-Auditor

A **Generative AI platform** that automatically audits customer support conversations, evaluates service quality, detects compliance issues, and provides actionable insights to improve customer experience.

The system processes **support calls or chat transcripts**, generates summaries, and evaluates interactions using **Large Language Models (LLMs)** to assign quality scores and highlight improvement opportunities.
